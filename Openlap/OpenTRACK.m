...
% filename = 'Tracks/Paul Ricard data.csv' ;
% filename = 'Tracks/Spa-Francorchamps.xlsx' ;
% filename = 'Tracks/Monza Data.csv' ;
...
% filename = 'Tracks/Michigan_2014';

% filename = 'a__Tracks/FSAE Endurance germany 2012';
% filename = 'a__Tracks/FSAE Autocross germany 2012';
% filename = 'a__Tracks/FSAE Skidpad';
% filename = 'a__Tracks/FSAE Acceleration';
